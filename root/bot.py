...
BOT_DESCRIPTION = """
👴🕶️ PrivadoVPN — https://kosia-zlo.github.io/mysite/faq.html

⚡ VPN-бот для своих:
— 🧑‍💻 ЕVPN который обходит только заблокированные сервисы
— 🕳️ Генерация конфигов OpenVPN прям в Боте
— 🧾 Статистика никому не нужная
— 🪣 МБ будет Vless позже)

Как получить VPN?
🪪 Жми /start, отправляй заявку, жди одобрения!

🟣https://kosia-zlo.github.io/mysite/faq.html Инструкция по установке и подключению
"""

BOT_SHORT_DESCRIPTION = "👴🕶️ PrivadoVPN— приватный VPN за минуту! https://kosia-zlo.github.io/mysite/faq.html"
